try {
    !function () {
        ...
        s.setPath('https://dup.baidustatic.com/'), s.define({
            ...
            name: "log", namespace: "dup.common.utility", deps: {
                config: "dup.common.config", lang: "dup.common.utility.lang", event: "dup.common.utility.event",
                storage: "dup.common.utility.storage"
            }, storageKey: "BAIDU_DUP_log_storage", loadImage: function (t, e) {
            ...
            }, sendEclickLog: function (t, e, i, n) {
                if (!t || !e) return "";
                var o = "//eclick.baidu.com/" + t + "?type=" + e;
                o += i ? "&key=" + i : "", o += n ? n : "", this.sendLog({url: o, option: "now"})
            }
        }), s.define({
            name: "monitor",
            namespace: "dup.business",
            ...
            launch: function () {
                try {
                    if (!window.___baidu_union_.expId) {
                        ...
                        "112000" === window.___baidu_union_.expId && 0 === t && this.initPageMonitor()
                    }
                } catch (i) {
                    var n = i && i.stack ? i.stack : i, o = this.config.LOG_URL;
            ...
            getAutoExpId: function () {
                ...
                return t = 3e3 > e ? "110011" : e >= 3e3 && 6e3 > e ? "110010" : e >= 6e3 && 6100 > e ? "112000" : "110000"
            },
            ...
            getDisParam: function () {
                for (var t = this.slotParam.paramsList, e = 0; e < t.length; e++) if ("dis" === t[e].key) return s.proxy(this.slotParam, t[e].value)()
            },
                ...
                this.dom.bind(document, "click", function () {
                    ...
                    if (i && e && (!document.visibilityState || "hidden" === document.visibilityState)) {
                        ...
                        var n = (new Date).getTime() - e,
                            ...
                            s = "&psid=" + o + "&time=" + n + "&click=" + t;
                        this.log.sendEclickLog("rs.jpg", "timeOnPage", "", s), e = 0, t = 0
                    }
                }))
            }
        }), s.define({
            ...
            containerFilter: function (t) {
                ...
                if (t.styleOpenApi) {
                    ...
                    if (t.styleOpenApi.scale) {
                        var c = t.styleOpenApi.scale.split("."), h = c[0] / c[1];
                        e = !(r > h)
                    }
                }
                return e
            ...
            hideAdContainer: function (t, e, i) {
                ...
                var o = t && setInterval(function () {
                    if (i > -1 * n) e.style[t] = --i + "px"; else {
                        clearInterval(o);
                        var s = e.id, r = s && s + "_closebtn_inside", a = document.getElementById(r);
            ...
            touchEnd: function (t, e, i, n) {
                ...
                if (this.pageY < this.startY && -10 > o && !this[i] && n === this.upSlideAnimation || this.pageY > this.startY && o > 10 && !this[i] && n === this.downSlideAnimation) {
                    this[i] = !0;
                    var s = document.getElementById(e), r = this.style.getStyle(s, i);
